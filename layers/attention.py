...
class Attention:
    ...
    def __init__(self, dkey, n_embed, seq_len, batch_size, n_heads, dropout_rate, eta, optim_type, wub, wlb, prefix, tau_m, w_bound=0.5, **kwargs):
        ...
        self.z_attn = RateCell(f"{prefix}z_attn", n_units=n_embed, tau_m=tau_m,
                            ...
                            prior=("gaussian", 0.1), resist_scale=0.5 )
