...
class Attention:
    ...
    def __init__(self, dkey, n_embed=config.n_embed, seq_len=config.seq_len, 
                 batch_size=config.batch_size, n_heads=config.n_heads, 
                 dropout_rate=config.dropout_rate, eta=config.eta, **kwargs):
        ...
        self.attn_block = AttentionBlock("attn_block", n_heads=n_heads, 
