    ...
    """
     def __init__(self, dkey, n_embed, seq_len, batch_size, vocab_size, eta, optim_type, wub, wlb, tau_m,  **kwargs):
        ...
        self.W_out = HebbianSynapse(
                    ...
                    bias_init=dist.constant(value=0.), w_bound=1., optim_type=optim_type, sign_value= -1.0, key=subkeys[4],prior=("l1l2", (0.001, 0.001)),pre_wght=config.hebb_scale, post_wght=config.hebb_scale)
