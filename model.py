...
class NGCTransformer:
    ...
    def __init__(self, dkey, batch_size, seq_len, n_embed, vocab_size, n_layers, n_heads, T, dt, tau_m, act_fx, eta, dropout_rate, exp_dir, model_name, loadDir=None, pos_learnable=False, optim_type="adam", wub=1.0, wlb=0.0, act_fx_o=config.act_fx_o, **kwargs):
        ...
        with Context("Circuit") as self.circuit:
            ...
            self.output = Output(dkey=subkeys[3], n_embed=self.n_embed, seq_len=self.seq_len, batch_size=self.batch_size, vocab_size=self.vocab_size, eta=eta, optim_type=optim_type, wlb=wlb, wub=wub, tau_m=tau_m, act_fx_o=act_fx_o)
        ...
        if loadDir is not None:
            ...
            with Context("Circuit") as self.circuit:
                ...
                for blocks in range(n_layers):
                    ...
                    block.mlp.E_mlp1.outputs >> block.ln2_grad.dmu_mlp1
                    block.ln2_grad.dmu_mlp1_out >> block.mlp.z_mlp1.j
                ...
                for i in range(n_layers):
                    ...
                    advance_process >> block.z_residual_attn.advance_state
                    advance_process >> block.z_residual_mlp.advance_state
                    ...
                    reset_process >> block.z_residual_attn.reset
                    reset_process >> block.z_residual_mlp.reset
