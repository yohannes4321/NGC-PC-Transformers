...
def define_search_space(trial):
    ...
    return {
        ...
        "act_fx": trial.suggest_categorical("act_fx", ["identity", "relu","sigmoid","tanh"]),
        "n_heads": n_heads,
        "n_embed": n_embed,
